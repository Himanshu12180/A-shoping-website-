      ...
      {data?.length > 0 ? (
        <div className="flex gap-6">
          ...
          <div className="w-1/4 hidden md:block mt-4">
            <div className="bg-black text-white rounded-lg p-4 shadow min-h-[400px]">
              <input
                type="text"
                placeholder="Search products..."
                className="border rounded px-3 py-2 w-full mb-4 bg-gradient-to-r from-purple-500 to-indigo-400 ring-sky-300"
              />
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-500 to-indigo-400 ring-sky-300 text-white px-4 py-2 rounded w-full"
              >
                Reset Filters
              </button>
            </div>
                ...
                <div className=" grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 mt-4 ">
                  ...
                  {filteredData
                    ...
                    .map((product) => (
                      <div
                        key={product.id}
                        className="bg-white blur-[2px]  border border-gray-200 rounded-lg shadow p-3 flex flex-col justify-between hover:blur-0 "
                        style={{ height: "320px" }}
                        onClick={() =>
                      ...
                      >
                        ...
                        className="mt-auto bg-gradient-to-r from-purple-500 to-indigo-400 ring-sky-300 text-white py-1.5 text-sm rounded flex items-center justify-center gap-2">
                          <FontAwesomeIcon
                            icon={faCartShopping}
                            className="w-4 h-4"
                          />
